...
namespace MultiPrecisionRootFinding {
    public static class NewtonRaphsonFinder<N> where N : struct, IConstant {

        public static MultiPrecision<N> RootFind(
            Func<MultiPrecision<N>, (MultiPrecision<N> v, MultiPrecision<N> d1)> f,
            MultiPrecision<N> x0,
        ...
        public static MultiPrecision<N> Delta(
            ...
            (MultiPrecision<N> v, MultiPrecision<N> d1) = f(x);

            MultiPrecision<N> dx = -v / d1;
